...
if(isset($_POST['login'])){
  ...
  if($rmbr==1){
    setcookie('uname', $username, time()+60*60*24*14,"/");
    setcookie('upass', $pass, time()+60*60*24*14,"/");
  }

  $sql = "SELECT * FROM user WHERE username='$username' && password = '$pass'";
  require_once('cn.php');
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4>LOGIN</h4>
              <h6 class="font-weight-light">Silahkan Tulis Username dan password anda</h6>
